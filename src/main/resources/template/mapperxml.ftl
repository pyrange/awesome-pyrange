...
<mapper namespace="${generateInfo.mapperPackage}.${generateInfo.moduleName}Mapper">
    ...
    <insert id="insert" parameterType="${generateInfo.modelPackage}.${generateInfo.moduleNameWithDot}.${generateInfo.moduleName}Po" keyProperty="${generateInfo.primaryKeyCamel}" useGeneratedKeys="true">
